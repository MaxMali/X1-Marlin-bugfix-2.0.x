...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Door Lock OFF"
  #define USER_GCODE_1 "M510\n M512 test" 

  #define USER_DESC_3 "Exhaust Filter ok"
  #define USER_GCODE_3 "M511 test" 

  #define USER_DESC_4 "Exhaust Filter NOT ok"
  #define USER_GCODE_4 "M117 hallol" 
